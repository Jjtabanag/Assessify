...
import examIcon from '../media/exam-icon.png';
import quizIcon from '../media/quiz-icon.png';
...
const CreateAssessmentPopup = ( { toggleCreatePrompt } ) => {
    return (
        ...
        <div className="prompt-container">
            ...
            <p> It's time to test how far the student has learned on a specific topic. <br />
            Choose the type of assessment you wish to create.</p>
            <div className="options-container">
                <Link to="/create-assessment?type=quiz">
                    <div className="option-box">
                        <img src={quizIcon} height="185" width="200" />
                        <h2> Quiz Type </h2>
                ...
                <Link to="/create-assessment?type=exam">
                    <div className="option-box">
                        <img src={examIcon} height="185" width="200" />
                        <h2> Exam Type </h2>
                        <p> Exams are a comprehensive assessment on multiple topics. Recommended for long form assessments. </p>
                    </div>
                </Link>
            </div>
            <Link onClick={toggleCreatePrompt}><div className="generic-button-variant"> Cancel </div></Link>
        </div>
