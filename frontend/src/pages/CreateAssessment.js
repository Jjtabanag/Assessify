  ...
  return (
    <main className="generic-content-container">
      ...
      <div className="content-header">
        <img
          src="static/media/quiz-icon.png"
          id="header-icon"
          width="115"
          height="110"
        />
      ...
      >
        <div class="general-attributes-form">
          ...
          <p>
            ...
            source material that is descriptive and comprehensive as to generate
            an equally quality assessment.{" "}
          </p>{" "}
          <br />
          <label> Materials Editor </label>
          <textarea
            class="generic-form-textarea-variant"
          ...
          <div class="custom-file-container">
            ...
            />
            <span class="custom-file-name" id="fileNameDisplay">
              No file chosen
            </span>
          </div>
          <button
        ...
        <div class="generator-attributes-form">
          ...
          <button
            class="generic-button-variant-2"
            id="section-.add-button"
            type="button"
            onclick="addNewSection()"
          >
            {" "}
            Add Exam Part/Section{" "}
          </button>
          <div id="assessment-section-container"></div>
        </div>
        <div class="submit-form-button">
          <button class="generic-button" type="submit">
            {" "}
            Create Assessment{" "}
          </button>
        </div>
      ...
      >
        ...
        <p>
          {" "}
          It seems like you have not properly filled-up all of the required data
          to create an assessment just yet.{" "}
        </p>
        <a href="javascript:void(0);" onClick={handleClosePrompt}>
          <div className="generic-button-variant"> Back </div>
        </a>
      </div>
